...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/mdsahilali",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@sahiil_.__",
    icon: Instagram,
    url: "https://www.instagram.com/sahiil_.__?igsh=MWFsZW5obnZkeWZtaQ%3D%3D&utm_source=qr",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@MdSahilAlii",
    icon: Github,
    url: "https://github.com/MdSahilAlii",
    color: "#ffffff",
